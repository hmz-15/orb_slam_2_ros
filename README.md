# ORB-SLAM2
**This is an adapted version of the original repo:**
- Fix coordinate transformation when output
- Fix load-in camera parameters
...
## Obtain dependencies
- OpenCV (3 or < 4.2)
- Eigen (> 3.1.0), provided as a catkin package using wstool:
```
cd <your-ros-ws>
wstool init src
cd src
